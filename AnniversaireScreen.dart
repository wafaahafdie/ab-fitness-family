// lib/AnniversaireScreen.dart - AVEC VISITEUR + TÉLÉCHARGEMENT
...
// ============================================================
// ANNIVERSAIRE SCREEN - AVEC VISITEUR + TÉLÉCHARGEMENT
// ============================================================

class AnniversaireScreen extends StatefulWidget {
  ...
  const AnniversaireScreen({
    super.key,
    required this.memberId,
    this.categoryName = 'Anniversaire',
    this.isVisitor = false,
    this.canDownload = false,
  });

  @override
  State<AnniversaireScreen> createState() => _AnniversaireScreenState();
}

class _AnniversaireScreenState extends State<AnniversaireScreen>
  ...
  void initState() {
    super.initState();
    debugPrint(
        '📌 AnniversaireScreen - isVisitor: ${widget.isVisitor}, canDownload: ${widget.canDownload}');
  ...
  void _shareOnSocial(Map<String, dynamic> app) async {
    ...
    try {
      await Share.share('$message${selectedUrls.join('\n\n')}');
    } catch (e) {
