...
const Color fieldBg = Color(0xFFF0F0F2);
const Color fieldText = Color(0xFF1E2235);
const Color titleColor = Color(0xFF1F2A6B);
const Color savePurple = Color(0xFF8E00C8);
const Color backCircleBg = Color(0xFFDFF6FF);

// ============================================================
// EDIT PASSWORD VISITEUR SCREEN
// ============================================================

class EditPVisiteur extends StatefulWidget {
  const EditPVisiteur({Key? key}) : super(key: key);

  @override
  State<EditPVisiteur> createState() => _EditPVisiteurState();
}

class _EditPVisiteurState extends State<EditPVisiteur> {
  ...
  Future<void> _enregistrer(BuildContext context) async {
    ...
    try {
      ...
      // ⭐ 5. Ré-authentifier l'utilisateur
      ...
      // ⭐ 7. Mettre à jour Firestore aussi (pour cohérence)
      try {
      ...
      debugPrint('✅ Mot de passe visiteur mis à jour : ${user.uid}');
