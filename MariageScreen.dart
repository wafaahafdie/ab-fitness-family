// lib/MariageScreen.dart - AVEC VISITEUR + TÉLÉCHARGEMENT
...
// ============================================================
// MARIAGE SCREEN - AVEC VISITEUR + TÉLÉCHARGEMENT
// ============================================================
...
class _MariageScreenState extends State<MariageScreen>
  ...
  void initState() {
    super.initState();
    debugPrint(
        '📌 MariageScreen - isVisitor: ${widget.isVisitor}, canDownload: ${widget.canDownload}');
